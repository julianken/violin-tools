...
4. **Skills index** — [`.claude/skills/`](.claude/skills/): `project-bootstrap` (orient/validate this instance), `pr-workflow` (open/review/merge), `issue-authoring` + `issue-plan-review` (spec a change, gate it before coding).
