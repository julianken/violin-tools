...
| [`figma.md`](./figma.md) | A Figma design system over the scoped-write MCP (read freely; write only on a feature/WIP page) | your design source of truth isn't Figma |
